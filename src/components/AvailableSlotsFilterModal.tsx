    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 py-4">
          {/* Row 1: Slot Type, Date & Status */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="available-slots-type-filter" className="text-sm font-medium">
                Slot Type
              </Label>
              <Select
              ...
              >
                <SelectTrigger id="available-slots-type-filter">
          ...
          {/* Row 3: Start Time & End Time — only visible when date is selected */}
          {filters.date && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="available-slots-start-time" className="text-sm font-medium">
                  Start Time
                </Label>
                <Input
                  id="available-slots-start-time"
                  type="time"
              ...
              <div className="space-y-2">
                <Label htmlFor="available-slots-end-time" className="text-sm font-medium">
                  End Time
                </Label>
                <Input
                  id="available-slots-end-time"
                  type="time"
