  ...
  const convertDocxToHtml = async (file: File): Promise<string> => {
    try {
      ...
      try {
        ...
        throw new Error(
          `Document conversion failed. This document may be too complex or corrupted. Please try with a simpler document.`,
        );
      }
    }
  };
  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your document has been converted and loaded into the editor.",
      });
          ...
          <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg text-sm">
            ...
            <div className="text-blue-800">
              ...
              <div className="text-xs mt-1 text-blue-600">
                Note: Complex documents with many images may take longer to
                process.
              </div>
            </div>
          </div>
