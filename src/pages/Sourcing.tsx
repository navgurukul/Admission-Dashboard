...
const Sourcing = () => {
  ...
  const pendingFollowUps = filteredApplicants.filter(
    (a) => !a.date_of_testing,
  ).length;
  const convertedToScreening = filteredApplicants.filter(
    (a) => a.final_marks !== null,
  ).length;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-card rounded-xl p-6 shadow-soft border border-border">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground mb-1">
                    Converted to Screening
                  </p>
                  <p className="text-2xl font-bold text-foreground">
                    {convertedToScreening}
                  </p>
                </div>
                        ...
                        <div className="flex flex-col items-center space-y-2">
                          ...
                          <span>
                            {searchQuery
                              ...
                              : "No applicants in sourcing stage"}
                          </span>
                        </div>
                      </td>
                    </tr>
                        ...
                        <td className="p-4">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm text-foreground">
                              {applicant.city
                                ? `${applicant.city}${applicant.block ? `, ${applicant.block}` : ""}`
                                : "Not specified"}
                            </span>
                          </div>
                        </td>
