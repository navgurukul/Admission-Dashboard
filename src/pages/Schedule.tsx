...
// import { Calendar, Clock, Plus, Users, Trash2, Edit, Video } from "lucide-react";
...
//   useEffect(() => {
//     fetchAllAvailableSlots(); // Fetch all slots on mount
//   }, []);
...
//       const response = await getMyAvailableSlots(); // No date parameter
...
//                           <thead>
//                             <tr className="bg-gradient-to-r from-orange-100 to-red-100 border-b-2 border-orange-300">
...
//                                   slot.is_booked ? "bg-red-50" : "bg-white"
//                                 }`}
//                               >
//                                 {/* Interviewer Name */}
...
//         onSuccess={() => {
//           fetchAllAvailableSlots(); // Refresh all slots
//         }}
//       />
