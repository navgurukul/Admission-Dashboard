...
export default function StudentLogin() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row relative">
      ...
      <div className="w-full lg:w-1/2 flex items-start lg:items-center justify-center p-4 pt-[68px] sm:p-8 lg:px-12 lg:py-2 student-bg-light min-h-[100dvh] lg:min-h-0">
        <div className="w-full max-w-lg">
          {/* Branding Section */}
          <div className="text-center mb-1.5 lg:mb-3">
            <div className="flex items-center justify-center mb-1.5 lg:mb-2">
              <div className="w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-secondary-purple to-primary rounded-2xl flex items-center justify-center shadow-lg transform transition-transform hover:scale-105">
                <User className="w-6 h-6 lg:w-7 lg:h-7 text-white" aria-hidden="true" />
              </div>
            </div>
            <h1 className="text-xl sm:text-2xl lg:text-2xl font-bold text-foreground mb-0.5 lg:mb-1">
              {getContent().title}
            </h1>
            <p className="text-sm sm:text-base lg:text-base text-muted-foreground px-2 lg:px-0">
          ...
          <Card className="shadow-2xl border-2 border-border/50 backdrop-blur-sm overflow-hidden">
            <CardContent className="pt-4 pb-4 px-4 lg:pt-5 lg:pb-5 lg:px-8 sm:px-10 space-y-3 lg:space-y-4">
              {/* Security Badge */}
              ...
              <form onSubmit={handleSubmit} className="space-y-2 lg:space-y-2.5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 lg:gap-2.5">
                  <div className="space-y-0.5 lg:space-y-1">
                    ...
                    <Input
                      ...
                      required
                      className="h-9 lg:h-10 text-[15px] lg:text-sm border-border/50 focus:border-primary/50"
                    />
                  </div>
                  <div className="space-y-0.5 lg:space-y-1">
                ...
                <div className="flex justify-center w-full">
                  <Button
                    type="submit"
                    className="w-[92%] sm:w-11/12 h-10 lg:h-11 text-[15px] lg:text-base font-semibold shadow-lg hover:shadow-xl transition-all active:scale-[0.98] mt-1 lg:mt-0"
                    disabled={loading}
                  >
                    {loading ? (
              ...
              {/* Help Text */}
              <div className="text-center space-y-2 lg:space-y-3 text-[13px] lg:text-sm pt-3 lg:pt-4 border-t border-border/50">
