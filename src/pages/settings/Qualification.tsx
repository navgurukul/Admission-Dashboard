  ...
  const [qualifications, setQualifications] = useState<Qualification[]>([
    {
      ...
      name: "High School",
      level: "Secondary",
      description: "10th standard completion",
      duration: "2 years",
    },
    {
      id: "2",
      ...
      description: "12th standard completion",
      duration: "2 years",
    },
    {
      id: "3",
      ...
      <div className="space-y-6" style={{ flex: 1 }}>
        <div>
          ...
          <p className="text-gray-600">
            Manage educational qualifications and levels
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create a new educational qualification
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage current educational qualifications
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                >
                  <div>
                    ...
                    <div className="flex gap-2 mt-2">
                      <span
                        className={`px-2 py-1 text-xs rounded ${getLevelColor(qualification.level)}`}
                      >
                        {qualification.level}
                      </span>
